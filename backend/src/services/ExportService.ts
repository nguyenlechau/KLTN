...
export class ExportService {
   ...
   */
  async generateExport(options: ExportOptions): Promise<Buffer> {
   ...
   */
  private async addRegistrationsSheet(workbook: ExcelJS.Workbook, options: ExportOptions) {
   ...
   */
  private async addItemsSheet(workbook: ExcelJS.Workbook, options: ExportOptions) {
   ...
   * Add Content sheet
   */
  private async addContentSheet(workbook: ExcelJS.Workbook, options: ExportOptions) {
    ...
    // Add data
    result.rows.forEach((content: any) => {
      sheet.addRow({
        ...content,
   ...
   * Add Locations sheet
   */
  private async addLocationsSheet(workbook: ExcelJS.Workbook, options: ExportOptions) {
   ...
   */
  private async addCategoriesSheet(workbook: ExcelJS.Workbook, options: ExportOptions) {
   ...
   */
  private async addOrdersSheet(workbook: ExcelJS.Workbook, options: ExportOptions) {
