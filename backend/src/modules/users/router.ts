...
usersRouter.post('/', authenticate, requirePermission('audit.view'), async (req: AuthenticatedRequest, res) => {
  try {
...
usersRouter.patch('/:id', authenticate, requirePermission('audit.view'), async (req: AuthenticatedRequest, res) => {
  try {
    const { id } = req.params;
...
usersRouter.delete('/:id', authenticate, requirePermission('audit.view'), async (_req: AuthenticatedRequest, res) => {
  try {
